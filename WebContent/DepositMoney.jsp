...
<br><br><br><label>Enter Amount</label>:<input type=text id="depositAmount" name=depositAmount >
<br><br><input type="submit" value="Deposit Amount" formaction="DepositMoneySuccessfull.jsp"  style="background-color:black; color:rgb(232,232,232); padding:14px 30px;" ><br>
</form>
</div></center>
</body>
